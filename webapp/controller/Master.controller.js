sap.ui.define([
	...
	return BaseController.extend("ate.activity.book.ATE.controller.Master", {
		...
		onAddItem: function () {
			this.getView("master").byId("addItem").setEnabled(false);
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "ate.activity.book.ATE.view.ViewSettingsDialog",
					controller: this
		...
		onSelectionChange: function (oEvent) {
			...
			this.getView("master").byId("addItem").setEnabled(true);
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("Nodeid")
			}, bReplace);
		},
