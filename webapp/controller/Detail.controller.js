sap.ui.define([
	...
	return BaseController.extend("ate.activity.book.ATE.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("parentSet", {
					Nodeid: sObjectId
				});
